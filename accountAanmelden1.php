...
<head>
    ...
    <title>Gemeente Rotterdam | Aanmelden</title>
</head>

<body>
    <header>
        <!-- navbar en header img van website -->
        <header header style="background-color: #474B4F;">
            <!-- navbar met foto -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                <a style="color: white;" class="nav-link active" href="includes/html/adminLogIn.php">Admin</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a style="color: white;" class="nav-link active" href="accountAanmelden1.php">Aanmelden</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <main class="userpaginaMain">
            ...
            <div class="container">
                <div style="height: auto; padding-bottom: 50px;" class="formContainer">
                    <form action="accountAanmelden2.php" class="form" method="POST">
                        <h2 style="color: #86C232;">U kunt hier ook inloggen</h2>
                        <div class="input-box">
                            <label label>Naam:</label>
                        ...
                        <button type="submit">Maak een account</button>
                    </form>
                    <a href="index.php"><button class="button">Annuleren</button></a>
                </div>
            </div>
